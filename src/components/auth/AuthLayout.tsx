  ...
  return (
    <div
      className={cn(
        ...
        'bg-gradient-to-br from-[#111111] via-[#1c1c1c] to-[#0d0d0d]',
        'dark:from-[#080808] dark:via-[#141414] dark:to-[#060606]'
      )}
    >
      {/* Glow blobs */}
      <div
      ...
      <div className="relative z-10 shrink-0">
        ...
        <p className="mt-2 text-[0.78rem] text-[#888888] dark:text-[#555555]">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center text-center">
        ...
        <p className="max-w-[280px] text-[0.85rem] leading-relaxed text-[#888888] dark:text-[#555555]">
          {t(SUBS[view])}
        </p>
      </div>
    </div>
