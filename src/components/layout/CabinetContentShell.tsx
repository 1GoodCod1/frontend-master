...
/** App header is fixed h-14 — cabinet column fills the rest of the viewport. */
export const CABINET_COLUMN_HEIGHT = 'h-[calc(100dvh-3.5rem)]';
    ...
    >
      <main
        ...
        className={cn(
          ...
          mobileTopPadding && 'pt-14 md:pt-0',
        )}
      >
