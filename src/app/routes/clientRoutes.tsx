  ...
  children: [
    {
      ...
      children: [
        ...
        { path: 'leads/:leadId/book', element: <LazyPage><P.ClientLeadBookPage /></LazyPage> },
        { path: 'masters/:slug/book', element: <LazyPage><P.DirectBookingPage /></LazyPage> },
        { path: 'lead-success/:leadId', element: <LazyPage><P.LeadSuccessPage /></LazyPage> },
        { path: 'leads', element: <LazyPage><P.ClientLeadsPage /></LazyPage> },
