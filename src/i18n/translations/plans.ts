  ...
  en: {
    plans: {
      ...
      comparisonTable: {
        ...
        exportLeads: 'Export leads (CSV, Excel, PDF)',
  ...
  ru: {
    plans: {
      ...
      comparisonTable: {
        ...
        exportLeads: 'Экспорт лидов (CSV, Excel, PDF)',
  ...
  ro: {
    plans: {
      ...
      comparisonTable: {
        ...
        availabilityStatus: 'Status disponibilitate & limită lead-uri',
        exportLeads: 'Export lead-uri (CSV, Excel, PDF)',
