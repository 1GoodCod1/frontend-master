export const privacy = {
  ...
  ru: {
    privacy: {
      ...
      section4P1:
        'Мы храним ваши данные, пока активна учётная запись или пока это необходимо для оказания услуг, урегулирования споров и соблюдения законодательства. Конкретные сроки хранения: история входов — 90 дней; данные об активности — 60 дней; лог-файлы — от 14 до 30 дней. Верификация: загруженные фото документов удаляются из хранилища вскоре после одобрения заявки; статус верификации сохраняется. Чувствительные данные (номера документов) шифруются при хранении. Пароли хешируются с помощью bcrypt. Все коммуникации шифруются при передаче через HTTPS.',
