export const referrals = {
  en: {
    referrals: {
      ...
      bonusDescription:
        'For each invited friend who completes their first request, you receive a bonus (masters: +7 days tariff, clients: bonus notification).',
      ...
      descQualified: 'Friend completed a request. You received a bonus!',
  ...
  ru: {
    referrals: {
      ...
      yourBonus: 'Ваш бонус',
      bonusDescription:
        'За каждого приглашённого друга, который завершит свою первую заявку, вы получаете бонус (мастерам: +7 дней тарифа, клиентам: уведомление о бонусе).',
      ...
      descQualified: 'Друг завершил заявку. Вам начислен бонус!',
  ...
  ro: {
    referrals: {
      ...
      bonusDescription:
        'Pentru fiecare prieten invitat care finalizează prima cerere, primești un bonus (meșterilor: +7 zile tarif, clienților: notificare bonus).',
      ...
      descQualified: 'Prietenul a finalizat o cerere. Ai primit un bonus!',
