...
export default function ResetPasswordHeader() {
  ...
  return (
    <div className="mb-8 text-center">
      <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-amber-100/80 dark:bg-amber-800/30 shadow-md transition hover:scale-105 hover:shadow-lg">
