      ...
      <div className="flex justify-center">
        <span
          className={cn(
            ...
            planColor === 'orange' &&
              'bg-orange-50 border border-orange-500 text-orange-500 dark:bg-orange-500 dark:border-transparent dark:text-white',
            planColor === 'teal' &&
              'bg-teal-50 border border-teal-500 text-teal-600 dark:bg-teal-500 dark:border-transparent dark:text-white'
          )}
        >
          <Check
            className={cn(
              ...
              planColor === 'orange' && 'text-orange-500 dark:text-white',
              planColor === 'teal' && 'text-teal-600 dark:text-white'
            )}
            strokeWidth={2.5}
          />
        </span>
        ...
        {(['basic', 'vip', 'premium'] as const).map((plan) => (
          <div
            ...
            className={cn(
              ...
              plan === 'vip' && 'text-orange-500 dark:text-orange-400',
              plan === 'premium' && 'text-teal-600 dark:text-teal-400'
            )}
          >
            {t(`plans.${plan}.name`)}
          </div>
