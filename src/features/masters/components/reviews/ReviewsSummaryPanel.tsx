...
export function ReviewsSummaryPanel({
  ...
  return (
    <div className={cn('flex flex-col sm:flex-row gap-3 p-3 border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5', masterDetailInsetCls)}>
      <div className={cn('flex flex-col items-center justify-center shrink-0 px-5 py-2.5 bg-amber-500/15 dark:bg-amber-500/20', masterDetailInsetCls)}>
